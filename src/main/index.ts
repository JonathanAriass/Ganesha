...
import { registerIpcHandlers, closeAllTunnels, unloadLlm, stopAllSsmTunnels, stopTelescopeTails } from './ipc'
...
app.on('will-quit', () => { void closeAllTunnels(); void unloadLlm(); stopAllSsmTunnels(); stopTelescopeTails() })
